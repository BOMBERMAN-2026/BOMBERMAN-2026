#ifndef MENU_INTRO_HPP
#define MENU_INTRO_HPP
...
public:
    ...
    bool updateIntro(float deltaTime);  // Retorna true cuando intro termina
    void updateMenu(float deltaTime);

    // Renderizado
    void renderIntro(GLuint VAO, GLuint shader, GLuint uniformModel, GLuint uniformProjection,
